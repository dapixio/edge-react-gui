...
import { getRenewalFee, renewFioAddress } from '../../modules/FioAddress/util'
...
export class FioAddressSettingsScene extends Component<Props, State> {
  ...
  onConfirm = async () => {
    ...
    try {
      ...
      const { expiration } = await renewFioAddress(fioWallet, fioAddressName, renewalFee)
      ...
      <SceneWrapper>
        ...
        {!showRenew && (
          <View style={styles.blockPadding}>
            <PrimaryButton2 onPress={this.onNextPress} disabled={feeLoading}>

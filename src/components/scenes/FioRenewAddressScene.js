...
type Props = StateProps & RouteProps & DispatchProps & CheckConnectivityProps
...
export class FioRenewAddressScene extends Component<Props, State> {
  ...
  onNextPress = async () => {
    const { fioAddressName, setFioAddress, checkConnectivity } = this.props
    ...
    try {
      ...
      Alert.alert(s.strings.fio_request_renew_ok_header, s.strings.fio_request_renew_ok_text)
      Actions.pop()
    } catch (e) {
    ...
    return (
      <View style={containerStyles}>
        <View style={styles.texts}>
          <T style={[styles.title, textStyles]}>{s.strings.fio_address_confirm_screen_label}</T>

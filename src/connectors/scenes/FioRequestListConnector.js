...
const mapDispatchToProps = (dispatch: Dispatch): DispatchProps => ({
  ...
  fioRejectRequest: (fioRequestId: string, payerFioAddress: string, payeeFioAddress: string, cb: Function) => {
    dispatch(rejectRequest(fioRequestId, payerFioAddress, payeeFioAddress, cb))
  },

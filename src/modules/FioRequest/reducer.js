...
export const fioRequest: Reducer<FioRequestState, Action> = (state = initialState, action: Action) => {
  switch (action.type) {
    ...
    case 'FIO/FIO_REQUEST_LIST_PENDING':
      ...
      const fioRequestsPending = action.data.page === 1 ? action.data.fioRequestsPending : [...state.requests, ...action.data.fioRequestsPending]
      return {
        ...state,
    ...
    case 'FIO/FIO_REQUEST_LIST_SENT':
      ...
      const fioRequestsSent = action.data.page === 1 ? action.data.fioRequestsSent : [...state.sentRequests, ...action.data.fioRequestsSent]
      return {
        ...state,

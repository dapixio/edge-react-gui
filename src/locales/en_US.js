...
const strings = {
  ...
  fragment_send_send_to_fio_error_inline: 'The provided FIO address is not available',
  fragment_send_send_to_fio_memo_error: 'Invalid Memo',
  fragment_send_send_to_fio_error_memo_inline: 'Memo must be less than 64 characters and contain symbols from latin alphabet',
  ...
  fio_request_by_fio_address_error_no_address: 'Before you can request funds using FIO Address, you must first register your own FIO Address. See Menu.',
  fio_request_by_fio_address_error_invalid_amount_header: 'Invalid Amount',
  fio_request_by_fio_address_error_invalid_amount: 'Please enter an amount before sending by FIO Address',
  fio_request_amount: 'Amount:',
  fio_request_requesting_from: 'Send request to',
  fio_request_requesting_to: 'Send request from',

...
const strings = {
  ...
  network_alert_text: 'FIO functionality requires internet connection.',
  fio_request_by_fioaddress_error_no_address_header: 'Register FIO Address',
  fio_request_by_fioaddress_error_no_address: 'Before you can request funds using FIO Address, you must first register your own FIO Address. See Menu.',
  fio_request_by_fioaddress_error_invalid_amount_header: 'Invalid Amount',
  fio_request_by_fioaddress_error_invalid_amount: 'Please enter an amount before sending by FIO Adress',
  fio_request_renew_ok_header: 'Address Renew',
  fio_request_renew_ok_text: 'Your address has been successfully renewed',
  fio_request_amount: 'Amount:',
  fio_request_requesting_from: 'Requesting From',
  fio_request_memo: 'Memo',
  fio_reqiuest_ok_header: 'Request Sent',
  fio_reqiuest_error_header: 'Request Failed',
  fio_reqiuest_ok_body: 'Your request has been successfully sent',
  ...
  fragment_send_send_to_fio: 'FIO Address',
  ...
  fragment_send_send_to_fio_memo: 'Memo',
  fragment_send_send_to_fio_memo_error: 'Invalid Memo',
  fragment_send_send_to_fio_error_memo_inline: 'The provided Memo is not valid',
  ...
  fio_memo: 'Memo',
  fio_pendingrequest: 'Pending Requests',
  fio_sentrequest: 'Sent Requests',
  ...
  string_save: 'Save',
  string_share: 'Share',
  string_share_fio_address: 'Fio Address',
  ...
  title_fio_request: 'FIO Requests',
  ...
  fio_address_register_screen_button_next: 'Next',
  ...
  fio_renew_address_fee_label: 'Renewal Fee',
  fio_renew_label: 'Renew',
  ...
  fio_reject_request_title: 'Reject',

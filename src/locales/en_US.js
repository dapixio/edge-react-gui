...
const strings = {
  ...
  fio_domain_reg_text: 'Need to note that you need to use FIO to register an address on a custom domain.',
  ...
  fio_domain_wallet_selection_text:
    'FIO Domain requires an annual fee. This payment is required by the FIO Protocol and not a requirement of Edge. The current annual cost is equivalent to %s FIO, but may fluctuate in the future. Select a wallet to pay from:',
